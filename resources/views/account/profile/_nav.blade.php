<ul class="nav nav-tabs mb-3">
    ...
    <li class="nav-item"><a class="nav-link active" href="{{ route('account.profile.home') }}">Profile</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('account.tickets.index') }}">Tickets</a></li>
</ul>
