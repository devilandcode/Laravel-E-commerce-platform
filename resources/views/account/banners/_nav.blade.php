<ul class="nav nav-tabs mb-3">
    ...
    <li class="nav-item"><a class="nav-link" href="{{ route('account.banners.index') }}">Adverts</a></li>
    <li class="nav-item"><a class="nav-link" href="{{ route('account.favorites.index') }}">Favorites</a></li>
    <li class="nav-item"><a class="nav-link active" href="{{ route('account.banners.index') }}">Banners</a></li>
